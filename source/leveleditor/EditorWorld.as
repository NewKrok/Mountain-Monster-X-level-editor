package leveleditor
{
	...
	public class EditorWorld extends BaseUIComponent
	{
		...
		protected var _cameraBound:CameraBound;
		...
		override protected function inited():void
		{
			...
			addChild(_cameraBound = new CameraBound(this));
		...
		public function loadLevel( levelData:LevelDataVO ):void
		{
			...
			if( levelData.gameObjects.length > 0 )
			{
				_finishMarker.x = levelData.gameObjects[0].x;
				_finishMarker.y = levelData.gameObjects[0].y;
				_finishMarker.scaleX = levelData.gameObjects[0].scaleX;
				_finishMarker.scaleY = levelData.gameObjects[0].scaleY;
				_finishMarker.rotation = levelData.gameObjects[0].rotation;
			}
		...
		public function getLevelData():LevelDataVO
		{
			...
			finishObject.y = _finishMarker.y;
			finishObject.rotation = _finishMarker.rotation;
			finishObject.scaleX = _finishMarker.scaleX;
			finishObject.scaleY = _finishMarker.scaleY;
			finishObject.pivotX = 0;
			finishObject.pivotY = 0;
			finishObject.texture = "table_world_0_b";
			levelData.gameObjects.push( finishObject );
