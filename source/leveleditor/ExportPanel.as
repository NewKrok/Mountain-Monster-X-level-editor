package leveleditor
{
	...
	public class ExportPanel extends BaseUIComponent
	{
		...
		protected function convertLevelDataToJSONString( levelData:LevelDataVO ):String
		{
			...
			data.worldId = levelData.worldId;
			data.levelId = levelData.levelId;
			data.cameraBounds = { x: levelData.cameraBounds.x, y: levelData.cameraBounds.y, width: levelData.cameraBounds.width, height: levelData.cameraBounds.height };
			data.gameObjects = levelData.gameObjects;
			...
			data.starValues = levelData.starValues;
