package leveleditor.controller
{
	...
	public class StarToolController
	{
		...
		{
			_sampleStar.x = snapToGrid( editorWorld.mouseX - _sampleStar.width / 2 );
			_sampleStar.y = snapToGrid( editorWorld.mouseY - _sampleStar.height / 2 );
		...
		protected function addStarRequest( e:MouseEvent ):void
		{
			if ( !editorWorld.isWorldDragged( ) )
			{
				...
				{
					addStar( editorWorld.mouseX - _sampleStar.width / 2, editorWorld.mouseY - _sampleStar.height / 2 );
				}
			}
		}
